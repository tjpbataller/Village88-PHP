...
imagestring($image, 4, 270, 70, "Cavite", $bus_body);
imagestring($image, 4, 270, 90, "Makati", $bus_body);
imagestring($image, 4, 270, 50, "10856", $bus_body);
imagestring($image, 4, 270, 110, "PHP 1200.00", $bus_body);
