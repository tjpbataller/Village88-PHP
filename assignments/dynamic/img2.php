...
imagestring($image, 4, 270, 70, "Lucban", $bus_body);
imagestring($image, 4, 270, 90, "La Union", $bus_body);
imagestring($image, 4, 270, 50, "10854", $bus_body);
imagestring($image, 4, 270, 110, "PHP 440.00", $bus_body);
