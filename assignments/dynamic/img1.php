...
imagestring($image, 4, 270, 70, "Davao", $bus_body);
imagestring($image, 4, 270, 90, "North Cotabato", $bus_body);
imagestring($image, 4, 270, 50, "10853", $bus_body);
imagestring($image, 4, 270, 110, "PHP 120.00", $bus_body);
