...
imagestring($image, 4, 270, 70, "Batanes", $bus_body);
imagestring($image, 4, 270, 90, "Jolo", $bus_body);
imagestring($image, 4, 270, 50, "10855", $bus_body);
imagestring($image, 4, 270, 110, "PHP 70.00", $bus_body);
